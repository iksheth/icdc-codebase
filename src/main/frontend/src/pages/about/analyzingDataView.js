  ...
  <>
    ...
    <div className={classes.container}>
      <Body data={{
        ...
        body: (
          <div>
            <b>From ICDC to Cloud Resources:</b>
            <br />
            <br />
Researchers find cases/cohorts in ICDC and then identify the files they would like
to use for analysis. This list of files is called a Manifest. The user will download
he Manifest and then upload the Manifest into Seven Bridges Genomics (SBG) where the
iles will be available for analysis. The user will need a Seven Bridges Genomics
account. The Manifest file is a text file consisting of CRDC Identifiers and, on
uploading to SBG, the user will be able to access the relevant data files and see
...
Currently the ICDC supports analysis via the Seven Bridges Genomics Cloud Resource.
            ...
            <br />
            <br />
            <b>Seven Bridges Cancer Genomics Cloud</b>
            <br />
            <br />
The Seven Bridges Cancer Genomics Cloud, hosted on Amazon Web Services, has a rich
 user interface that allows researchers to find data of interest and combine it with
 heir own private data. Data can be analyzed using more than 200 preinstalled,
 curated bioinformatics tools and workflows. Researchers can also extend the
  functionality of the platform by adding their own data and tools via an intuitive
   software development kit.
            <br />
            <br />
            <b>Institute for Systems Biology ISB Cloud</b>
            <br />
            <br />
The ISB Cancer Genomics Cloud, leveraging many aspects of the Google Cloud Platform,
lows scientists to interactively define and compare cohorts, examine underlying
...
Google Cloud Platform (GCP) resources such as BigQuery and Google Pipeline service,
 ...
 data available in the Google Cloud Storage.
            <br />
            <br />
            <b>Broad Institute FireCloud</b>
            <br />
            <br />
FireCloud is an open, standards-based platform for performing production-scale
 data analysis in the cloud. Built on the Google Cloud Platform, FireCloud empowers
 nalysts, tool developers, and production managers to run large-scale analysis and
